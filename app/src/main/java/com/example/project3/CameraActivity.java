...
public class CameraActivity extends AppCompatActivity {
    ...
    Button btn_photo;
    ImageView iv_photo;
    final static int TAKE_PICTURE = 1; // 경로 변수와 요청변수 생성 String mCurrentPhotoPath; final static int REQUEST_TAKE_PHOTO = 1;
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this, "com.example.project3.fileprovider", photoFile);
